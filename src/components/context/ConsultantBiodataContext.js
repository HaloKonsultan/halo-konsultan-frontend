...
export const ConsultantBiodataContext = createContext()

export const ConsultantBiodataProvider = props => {
    ...
    const [input, setInput] = useState({
     ...
     return (
         <ConsultantBiodataContext.Provider value ={{
            dataBiodata,
            setDataBiodata,
            input,
            setInput,
            ...
            setFetchStatus
                ...
                {props.children}
         </ConsultantBiodataContext.Provider>
     )
